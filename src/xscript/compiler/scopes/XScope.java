...
public class XScope {
	...
	protected final HashMap<String, XVar> locals = new HashMap<String, XVar>();
	
	protected final HashMap<String, XVar> accessed = new HashMap<String, XVar>();
	...
	XScope(XScope thiz){
		...
		locals.putAll(thiz.locals);
		accessed.putAll(thiz.accessed);
		localsAllowed = false;
		_break = null;
		_continue = null;
		labels = null;
