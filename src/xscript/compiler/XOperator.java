...
public enum XOperator {
	...
	LET("=", INFIX, 0, false, XOpcode.NOP), LETADD("+=", INFIX, 0, XOpcode.LADD), LETSUB("-=", INFIX, 0, XOpcode.LSUB), LETMUL("*=", INFIX, 0, XOpcode.LMUL), LETPOW(
			"**=", INFIX, 0, XOpcode.LPOW), LETDIV("/=", INFIX, 0, XOpcode.LDIV), LETIDIV("\\=", INFIX, 0, XOpcode.LIDIV), LETMOD("%=", INFIX, 0, XOpcode.LMOD), LETOR(
			"|=", INFIX, 0, XOpcode.LOR), LETAND("&=", INFIX, 0, XOpcode.LAND), LETXOR("^=", INFIX, 0, XOpcode.LXOR), LETSHR(">>=", INFIX, 0, XOpcode.LSHR), LETSHL(
			"<<=", INFIX, 0, XOpcode.LSHL), LETISHR(">>>=", INFIX, 0, XOpcode.LISHR), COPY("<:", INFIX, 0, false, XOpcode.NOP),
	...
	UNPACKLIST("*", PREFIX, -1, false, XOpcode.NOP), UNPACKMAP("**", PREFIX, -1, false, XOpcode.NOP),
	...
	XOperator(String op, Type type, int priority, XOpcode opcode) {
		this(op, type, priority, true, opcode);
	}
