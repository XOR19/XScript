...
public class XOutputStreamSave extends OutputStream implements DataOutput {

	private ByteArrayOutputStream outputStream;
	private List<String> constDict = new ArrayList<String>();
	
	public XOutputStreamSave(){
	...
	public void writeToOutputStream(OutputStream outputStream) throws IOException{
		...
		outputStream.write(constDict.size()>>>24);
		outputStream.write(constDict.size()>>>16);
