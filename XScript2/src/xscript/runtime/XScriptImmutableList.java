...
final class XScriptImmutableList<E> implements List<E> {

	private E[] array;
	private int start;
	private int end;
	
	XScriptImmutableList(E...array){
		this.array = array;
		start = 0;
		end = array.length;
	}
	
	private XScriptImmutableList(E[] array, int start, int end){
		this.array = array;
		this.start = start;
		this.end = end;
	}
	...
	public List<E> subList(int start, int end) {
		...
		return new XScriptImmutableList<E>(array, this.start+start, this.start+end);
	}
